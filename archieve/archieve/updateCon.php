      ...
      //not empty
        ...
        $valid=true;
            ...
            if($valid){
					  ...
					  //inserting data 
					  $stmt=$conn->prepare("UPDATE workOrder SET :student_faculty,:first_name,:last_name,:greenriverID,:email,:phone_number,:computer_language,:computer_username,:computer_password,:ccleaner,:customer_initials,:issues WHERE ");
